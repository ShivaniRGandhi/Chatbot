...
quit_list = ['bye','exit', 'quit']
thanks_list = ['thanks', 'thank you', 'thanks Percy']
welcome_input = ("hey", "hi", "hello", "hey there", "what's up", "hello there",)
welcome_response = ["Hello ", "*nods* ", "*smiles*", "Hey there!",
                    "Why hello there ","Oh, hi there. Fancy meeting you here ",
                    "Nice to meet you ", "*blushes*"]
generation_response = ["To get more details, ask me questions in the following format: Tell me about _____\nEasy right, ", "What else do you want information on ","I would say I'm quite the smarty pants :) ;feel free to ask me more questions ", "I hope you're having fun. Ask me something else, "]
...
def botResponse(user_input):
    ...
    # found in knowledge base
        ...
        responses = ["You just really know what questions to ask don't you! Here's what I found:", "Hmm, here's what I found on that:",
                     "Great question! Check this out:", "Oh wow, let me see what I can dig up for you:",
                     "Give me a second.. I need to think on that one....Ok got it. Hows this:"]
...
def print_topic():
    ...
    responses = ["Wow I've always wanted to learn more about ",
                 "Hmm, let me see what I can find ", "Here is what I found on ",
                 "This is information on ", "Oh wow, let me see what I can dig up ",
...
name = input("What is your name? (Please enter a one word response) \n").capitalize()
...
continue_flag=True
print("Hi " + name + " what would you like to learn about today?")
while(continue_flag == True):
    ...
    if(user_response not in quit_list):
        if(user_response in thanks_list ):
            continue_flag  = False
            print("Percy: You are welcome " + name + " :D")
        ...
        # generate responses to the user's input
            ...
            if(welcomeMessage(user_response)!= None):
                ...
                print(random.choice(generation_response) + name)
